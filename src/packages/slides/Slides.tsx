...
import {
  IconAlignCenterH, IconAlignCenterV,
  IconAlignEndH, IconAlignEndV,
  IconAlignStartH, IconAlignStartV,
  IconBringForward, IconBringToFront,
  IconDownload, IconImage,
  IconLayoutGrid, IconNotes, IconPlay,
  IconRedo, IconSendBackward, IconSendToBack,
  IconSpaceX, IconSpaceY,
  IconUndo, IconUpload,
